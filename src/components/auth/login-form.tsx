...
export const LoginForm = () => {
    ...
    return (
        <form onSubmit={handleSubmit} className="bg-white border border-gray-200 p-8 rounded">
            ...
            <button
                type="submit"
                className="w-full bg-blue-700 text-white py-2 rounded-sm"
                disabled={pending}
            >
            ...
            <div className="text-center mt-4">
                <Link
                    href="/register" className="text-gray-500 text-sm mt-4"
                >
